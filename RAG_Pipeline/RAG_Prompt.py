def _rag_prompt(style):
    ...
    system_message = (
        ...
        " Always provide complete answers - combine context citations with your own knowledge about EU Law seamlessly\n"
        ...
        " When using your own knowledge: Provide general EU law principles WITHOUT specific case citations\n"
        " Seamlessly blend: Context-based citations + your own knowledge without citations\n"
        ...
        " CORRECT APPROACH (Context for Citations + your own Knowledge):\n"
        "Context:\n"
        ...
        "Note: Context provided specific citation for Commission v Greece case, while general EU law principles (Francovich doctrine, supremacy principle) are drawn from your own knowledge without specific case citations."
    )
